...
title: "$BIFI: Intrinsic Value"
sub_header: "$BIFI: Intrinsic Value"
author: "Jack Gale"
short_description: "Examining gaps between $BIFI's price and NAV, Redemption For Value (RFV) strategies, and why intrinsic value makes RFV unattractive."
preview_image: "../../../public/images/articles/bifi-intrinsic-value/cover.webp"
header_media_type: "image"
header_media_url: "/images/articles/bifi-intrinsic-value/cover.webp"
...
> **TL;DR** - exploring the differences between $BIFI’s price, net asset value and intrinsic value, and why intrinsic value is far greater than NAV. Reviews “Redemption For Value” tactics, which value treasury at NAV alone, and argues that holders should expect more for their tokens than just a split of liquid treasury assets.
...
When price falls below NAV, it forces a deeper question: *is the value of $BIFI really greater than the value of our treasury?*
...
Before outlining the promise, let’s start with the peril: RFV.
...
In traditional finance, activist investors that pursue this strategy have been brandished as *“vultures”* or *“asset strippers”*, for their lack of compassion for the impact a liquidation would have on those involved in the business. But we, for one, are less emotive on this topic.
...
![Generated cartoon image of a cow being picked apart by vultures.](../../../public/images/articles/bifi-intrinsic-value/vultures.webp)

## A Legal Framework

When talking about DAOs and tokens, rather than companies and shares, we need to resign ourselves to the absence of formal legal guidance.
...
![Generated cartoon image of a judge ordering business people.](../../../public/images/articles/bifi-intrinsic-value/court.webp)

## Intrinsic Value

With the peril clear, let’s turn to the promise. 
...
![Generated cartoon image of Warren Buffett and Charlie Munger meditating.](../../../public/images/articles/bifi-intrinsic-value/tao.webp)

## Beefy

For many years now, Beefy has prided itself on a common-sense, value-based approach to business management. We track finances closely, adapt as markets change, and offer our holders respect and transparency in all of our dealings.
...
For holders, price under NAV and the prospect of RFV pose only one real question: *are the prospects of the business recovering its intrinsic value so poor that it’s time to take the loss and give up?*
...
Stepping back, Beefy represents something more fundamental than a single product or a passing phase.
...
Beefy looks at fragmented rewards and asks: *“what if we automated them?”*. For tokens clenched in the fists of their issuers, Beefy is a constant reminder of the market’s forces. For those bootstrapping liquidity, Beefy is here to make things happen, with the honest truth about the right incentives.
...
And with that worth in mind, you have only one question to consider: are our prospects so bleak that you can no longer see the value between the assets?
